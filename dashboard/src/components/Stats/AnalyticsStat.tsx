...
const AnalyticsStat: React.FC<AnalyticsStatProps> = ({ label, value, unit }) => (
  <div className="glass-card p-10 rounded-[3rem] text-center space-y-2 group hover:scale-[1.05] transition-all duration-500 shadow-xl">
    ...
    <p className="text-5xl font-black text-slate-900 dark:text-white tracking-tighter group-hover:text-primary transition-colors">
      {value}
    </p>
